...
export const Nav = () => (
    <nav>
        <ul className="flex list-none p-0">
            ...
            <li className="hidden sm:block uppercase text-2xl text-gray-500 ml-8"><a href={'/music'}>Music</a></li>
            ...
            <li className="hidden sm:block uppercase text-2xl text-gray-500 ml-8">
